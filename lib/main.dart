...
class _UserListScreenState extends State<UserListScreen> {
  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      ...
      setState(() {
        _locationMessage =
            "Lat: ${position.latitude.toStringAsFixed(3)}, Local: ${position.longitude.toStringAsFixed(3)}";
      });
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        elevation: 10,
        shadowColor: bordeauxColor.withOpacity(0.5),
      ...
      body: Column(
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  icon:
                      const Icon(Icons.refresh, size: 16, color: bordeauxColor),
          ...
          Expanded(
            child: vm.isLoading
                ? const Center(
                    child: CircularProgressIndicator(color: bordeauxColor))
                : vm.users.isEmpty
                    ? Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Dismissible(
                              ...
                              return await showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: Text(
                                        "Ви точно хочете видалити користувача ${user.name}?"),
                                    shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(15),
                                      side: BorderSide(
                                          color:
                                              bordeauxColor.withOpacity(0.3)),
                                    ),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                            ...
                            onDismissed: (direction) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                    content: Text("${user.name} видалено"),
                            ...
                            background: Container(
                              ...
                              decoration: BoxDecoration(
                                color: bordeauxColor.withOpacity(0.8),
                                borderRadius: BorderRadius.circular(15),
                              ),
                            ...
                            child: Card(
                              ...
                              child: ListTile(
                                ...
                                leading: CircleAvatar(
                                  ...
                                  backgroundColor:
                                      bordeauxColor.withOpacity(0.2),
                                  child: userImage == null
                                      ? const Icon(Icons.person,
                                          size: 30, color: bordeauxColor)
                                      : null,
                                ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label:
            const Text("Додати", style: TextStyle(fontWeight: FontWeight.bold)),
