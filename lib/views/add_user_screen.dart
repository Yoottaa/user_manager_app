    ...
    final ImageSource? source = await showDialog<ImageSource>(
      ...
      builder: (context) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: bordeauxColor.withOpacity(0.3)),
        ),
        actions: [
          ListTile(
            ...
            children: [
                ...
                child: GestureDetector(
                  ...
                  child: Stack(
                    children: [
                      CircleAvatar(
                        radius: 55,
                        backgroundColor: bordeauxColor.withOpacity(0.1),
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: bordeauxColor, shape: BoxShape.circle),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  labelStyle:
                      TextStyle(color: isDark ? Colors.grey : bordeauxColor),
                  ...
                  focusedBorder: OutlineInputBorder(
                      borderSide: BorderSide(color: bordeauxColor, width: 2),
                      borderRadius: BorderRadius.circular(12)),
                ),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(
                          color: isDark ? Colors.grey : bordeauxColor),
                      prefixIcon:
                          Icon(Icons.alternate_email, color: bordeauxColor),
                      enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: isDark ? Colors.grey[800]! : Colors.grey),
                          borderRadius: BorderRadius.circular(12)),
                      focusedBorder: OutlineInputBorder(
                          borderSide:
                              BorderSide(color: bordeauxColor, width: 2),
                          borderRadius: BorderRadius.circular(12)),
                    ),
                    validator: (v) =>
                        !v!.contains('@') ? "Некоректний email" : null,
                  ),
                  const SizedBox(height: 10),
                  SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: Row(
                      children: _emailDomains
                          .map((domain) => Padding(
                                padding: const EdgeInsets.only(right: 8),
                                child: ActionChip(
                                  backgroundColor:
                                      bordeauxColor.withOpacity(0.15),
                                  label: Text(domain,
                                      style: TextStyle(
                                          color: isDark
                                              ? Colors.white
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      bool isDuplicate = viewModel.users.any((u) {
                        if (widget.user != null && u.id == widget.user!.id)
                          return false;
                      ...
                      if (isDuplicate) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                                "Користувач з такою поштою або телефоном вже існує!"),
